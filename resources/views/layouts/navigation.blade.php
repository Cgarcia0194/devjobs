        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                @auth
                    ...
                    @can('create', App\Models\Vacante::class)
                        <a class="mr-2 w-6 h-6 bg-blue-400 hover:bg-blue-600 rounded-full flex flex-col justify-center items-center text-sm font-extrabold text-white"
            ...
            <div class="pt-2 pb-3 space-y-1">
                ...
                @if (auth()->user()->role === 2)
                    <div class="flex gap-2 items-center p-3">
                        <a class="w-6 h-6 bg-blue-400 hover:bg-blue-600 rounded-full flex flex-col justify-center items-center text-sm font-extrabold text-white"
                            href="{{ route('notificaciones') }}">
                            {{ auth()->user()->unreadNotifications->count() }}
                        </a>
