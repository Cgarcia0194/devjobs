<div class="p-10">
    ...
    {{-- Sirve para saber si es reclutador o no lo toma de VacantePolicy create --}}
    {{-- cannot es como un if else es la negación de la directiva CAN --}}
